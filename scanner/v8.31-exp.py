...
# === RAID Hunter v8.31-exp ===
# На базе v8.30 + фильтры из candle-dump:
...
COOLDOWN_BARS = 12          # не входить по той же монете N свечей
...
def main():
    print(f"[{datetime.now().strftime('%H:%M:%S')}] === Scanner v8.31-exp запущен ===")
    print("v8.31 | body 4-9% | prev_pump<=3% | cooldown 12 | Score>=2 | full log")
