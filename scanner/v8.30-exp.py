...
# === RAID Hunter v8.30-exp ===
# Эксперимент: ослаблены объёмные фильтры для быстрого сбора статистики
# VOLUME_RATIO 1.9 → 1.7
# CONDITION_D 0.70 → 0.60
# True Sweep + Fresh Zone сохранены
# Полное логирование в signals/
...
def main():
    print(f"[{datetime.now().strftime('%H:%M:%S')}] === Scanner v8.30-exp запущен ===")
    print("EXP data-collect | Score>=2 | Vol 1.7 | CondD 0.60 | Sweep+Fresh | full log")
