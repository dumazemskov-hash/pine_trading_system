...
# === RAID Hunter v8.27 ===
# На базе v8.26, точечное ослабление:
# - MIN_ZONE_SCORE: 3 → 2
...
MIN_ZONE_SCORE = 2          # было 3
BREAK_ATR_MULT = 0.25       # было 0.40
STOP_ATR_MULT = 0.35
...
def main():
    print(f"[{datetime.now().strftime('%H:%M:%S')}] === Scanner v8.27 запущен ===")
    print("Score>=2 | Break 0.25*ATR | Closed candle | Stop cap 2%")
